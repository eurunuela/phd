...
\begin{figure*}[h!]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/synthesis_analysis/supp_hrf_differences.pdf}
    \end{center}
...
\begin{figure*}[h!]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/synthesis_analysis/regpath_spike.pdf}
    \end{center}
    ...
    Criteria (\acrshort*{aic} and BIC) optima. (Right) Estimated activity-inducing (blue)
...
\begin{figure*}[h!]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/synthesis_analysis/regpath_block.pdf}
    \end{center}
...
\begin{figure*}[h!]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/synthesis_analysis/supp_lambdas_map.pdf}
    \end{center}
...
\begin{figure*}[h!]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/synthesis_analysis/supp_mad_estimate.pdf}
    \end{center}
...
\begin{figure*}[h!]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/synthesis_analysis/supp_rss_comparison.pdf}
    \end{center}
    \caption{Root sum of squares (RSS) comparison between \acrlong*{pfm}
...
\begin{figure*}[h!]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/synthesis_analysis/supp_motor_regpaths.pdf}
    \end{center}
...
\begin{figure*}[h!]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/synthesis_analysis/supp_mad_inno_ts.pdf}
    \end{center}
...
\begin{figure*}[h!]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/synthesis_analysis/supp_task_maps_mad.pdf}
    \end{center}
...
\begin{figure*}[h!]
    \begin{center}
        \includegraphics[width=\textwidth]{figures/synthesis_analysis/supp_caps_mad.pdf}
    \end{center}
