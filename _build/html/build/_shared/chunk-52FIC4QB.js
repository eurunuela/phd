...
var noSemi, incdec, incdecPrefix, insertSemi, spaces, newline, LineComment, BlockComment, space, braceR, semicolon, slash, star, plus, minus, trackNewline, insertSemicolon, noSemicolon, incdecToken, jsHighlight, spec_identifier, spec_word, spec_LessThan, parser;
...
var snippets, cache, ScopeNodes, functionContext, gatherCompletions, Identifier, dontComplete, javascriptLanguage, jsxSublanguage, typescriptLanguage, jsxLanguage, tsxLanguage, keywords, android, autoCloseTags;
var init_dist9 = __esm({
  "../../node_modules/@codemirror/lang-javascript/dist/index.js"() {
    ...
    keywords = /* @__PURE__ */ "break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield".split(" ").map((kw) => ({ label: kw, type: "keyword" }));
    android = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent);
    autoCloseTags = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text) => {
...
//# sourceMappingURL=/build/_shared/chunk-52FIC4QB.js.map
