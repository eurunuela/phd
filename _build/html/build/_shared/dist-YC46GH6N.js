...
var containerHandler = (node, state) => {
  ...
  if (captions === null || captions === void 0 ? void 0 : captions.length) {
    ...
    state.renderChildren({
      children: captions.map((cap) => cap.children).filter(Boolean).flat()
    });
    state.write("\n],");
  }
  if (kind) {
...
var TypstSerializer = class {
  ...
  renderChildren(node, trailingNewLines = 0, delim = "") {
    var _a, _b, _c;
...
//# sourceMappingURL=/build/_shared/dist-YC46GH6N.js.map
