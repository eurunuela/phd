...
var handlers = {
  ...
  code(node, state) {
    ...
    let end = "\n\\end{verbatim}";
    if (getClasses(node.class).includes("listings") && node.lang !== void 0) {
      state.usePackages("listings");
      start = `\\begin{lstlisting}[language=${node.lang}]
`;
      end = "\n\\end{lstlisting}";
    } else if (getClasses(node.class).includes("minted") && node.lang !== void 0) {
...
//# sourceMappingURL=/build/_shared/dist-POJ46ZFS.js.map
