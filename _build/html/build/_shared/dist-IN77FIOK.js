...
var require_utils = __commonJS({
  "../../node_modules/markdown-it/lib/common/utils.js"(exports) {
    ...
    function has(object, key) {
      return _hasOwnProperty3.call(object, key);
    }
    function assign(obj) {
    ...
    d = function(o2) {
      ...
      for (let d2 = l2 > 0 ? l2 + 1 : 0; d2 < e2; ) {
        ...
        for (let n3 = 1, s3 = 36; ; s3 += 36) {
          ...
          const l4 = (u3 = o2.charCodeAt(d2++)) - 48 < 10 ? u3 - 22 : u3 - 65 < 26 ? u3 - 65 : u3 - 97 < 26 ? u3 - 97 : 36;
...
var decode, encode, toASCII, toUnicode, ucs2, version;
...
function roleRule(state, silent) {
  ...
  if (!silent) {
    ...
    token.meta = { name };
    token.content = content;
    token.col = [state.pos, state.pos + str3.length];
  }
  ...
  md.inline.ruler.after("emphasis", "citation", (state, silent) => {
    ...
    if (char == 64 && (state.pos == 0 || regexes.allowedBefore.test(state.src.slice(state.pos - 1, state.pos)))) {
      ...
      if (end > 0 && charAfter != 40 && charAfter != 91) {
        const str3 = state.src.slice(state.pos + 1, end);
        const parts = str3.split(";").map((x) => x.match(regexes.citation));
...
var includeDirective = {
  ...
  run(data, vfile) {
    ...
    if ((_k = data.options) === null || _k === void 0 ? void 0 : _k.lines) {
      filter.lines = parseLinesString(vfile, (_l = select('mystDirectiveOption[name="lines"]', data.node)) !== null && _l !== void 0 ? _l : void 0, (_m = data.options) === null || _m === void 0 ? void 0 : _m.lines);
    } else {
...
function parseLinesString(vfile, node, linesString) {
  if (!linesString)
    return void 0;
  return linesString.split(",").map((l2) => {
    const line = l2.trim();
...
function ensureOnlyOneOf(data, vfile, exclusive) {
  ...
  const set22 = new Set(Object.keys(options));
  const intersection = new Set([...set1].filter((x) => set22.has(x)));
...
- \`epigraph\`: used for a blockquote node that are usually found at the beginning of a document`
  ...
  run(data) {
    ...
    const container = {
      ...
      label,
      identifier,
      class: (0, import_classnames.default)({ [className]: className, [data.name]: data.name !== "blockquote" }),
      children: [
        {
...
var rawDirective = {
  ...
  run(data) {
    ...
    return [
      {
        type: "raw",
        lang: (_a = data.arg) !== null && _a !== void 0 ? _a : "",
...
var citeRole = {
  ...
  run(data) {
    ...
    const children = labels.map((c2) => {
      var _a, _b;
      const groups = /^(?:\{([^{]*)\})?([^{]*)(?:\{([^{]*)\})?$/;
      const [, prefix, l2, suffix] = (_a = c2.match(groups)) !== null && _a !== void 0 ? _a : ["", "", c2];
      const { label, identifier } = (_b = normalizeLabel(l2)) !== null && _b !== void 0 ? _b : {};
      const cite = {
        type: "cite",
        kind,
...
js-yaml/dist/js-yaml.mjs:
  (*! js-yaml 4.1.0 https://github.com/nodeca/js-yaml @license MIT *)
*/
//# sourceMappingURL=/build/_shared/dist-IN77FIOK.js.map
