...
var DOMSelectionState, preventScrollSupported, scratchRange, DOMPos, noChildren, ContentView, ChildCursor, nav, doc, ie_edge, ie_upto10, ie_11up, ie2, gecko, chrome, webkit, safari, ios, browser, MaxJoinLen, TextView, MarkView, WidgetView, WidgetBufferView, noAttrs, LineView, BlockWidgetView, WidgetType, BlockType, Decoration, MarkDecoration, LineDecoration, PointDecoration, ContentBuilder, NullWidget, clickAddsSelectionRange, dragMovesSelection$1, mouseSelectionStyle, exceptionSink, updateListener, inputHandler, focusChangeEffect, perLineTextDirection, nativeSelectionHidden, ScrollTarget, scrollIntoView, editable, nextPluginID, viewPlugin, ViewPlugin, PluginInstance, editorAttributes, contentAttributes, decorations, atomicRanges, bidiIsolatedRanges, scrollMargins, styleModule, ChangedRange, ViewUpdate, Direction, LTR, RTL, LowTypes, ArabicTypes, Brackets, BracketStack, BidiRE, BidiSpan, types, movedOver, DocView, BlockGapWidget, DecorationComparator$1, InputState, PendingKeys, EmacsyPendingKeys, modifierCodes, dragScrollMargin, MouseSelection, handlers, observers, brokenClipboardAPI, insideY, inside, BadMouseDetail, lastMouseDown, lastMouseDownCount, lastMouseDownTime, lastLinewiseCopy, isFocusChange, appliedFirefoxHack, wrappingWhiteSpace, HeightOracle, MeasuredHeights, BlockInfo, QueryType, Epsilon, HeightMap, HeightMapBlock, HeightMapText, HeightMapGap, HeightMapBranch, relevantWidgetHeight, NodeBuilder, DecorationComparator2, LineGap, LineGapWidget, ViewState, Viewport, IdScaler, BigScaler, theme, darkTheme, baseThemeID, baseLightID, baseDarkID, lightDarkIDs, baseTheme$1, LineBreakPlaceholder, DOMReader, DOMPoint, DOMChange, observeOptions, useCharData, DOMObserver, EditorView, MaxBidiLine, BadMeasure, CachedOrder, currentPlatform, handleKeyEvents, keymap, Keymaps, storedPrefix, PrefixTimeout, RectangleMarker, LayerView, layerOrder, CanHidePrimary, selectionConfig, cursorLayer, selectionLayer, themeSpec, hideNativeSelection, MatchDecorator, UnicodeRegexpSupport, Specials, Names, _supportsTabSize, specialCharConfig, _plugin, DefaultPlaceholder, SpecialCharWidget, TabWidget, plugin, lineDeco, activeLineHighlighter, MaxOff, keys, showCrosshair, tooltipConfig, baseTheme, panelConfig, panelPlugin, PanelGroup, showPanel, GutterMarker, gutterLineClass, defaults, activeGutters, unfixGutters, gutterView, UpdateContext, SingleGutterView, GutterElement, lineNumberMarkers, lineNumberConfig, NumberMarker, lineNumberGutter, WhitespaceDeco, whitespaceHighlighter, trailingHighlighter;
var init_dist2 = __esm({
  "../../node_modules/@codemirror/view/dist/index.js"() {
    ...
    WhitespaceDeco = /* @__PURE__ */ new Map();
...
//# sourceMappingURL=/build/_shared/chunk-56LNZOHZ.js.map
