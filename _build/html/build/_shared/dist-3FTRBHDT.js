import {
  ...
  snippetCompletion
} from "/build/_shared/chunk-VLMSMCSI.js";
import {
  ContextTracker,
  ExternalTokenizer,
  IterMode,
...
var printKeyword, indent, dedent, newline$1, blankLineStart, newlineBracketed, eof, formatString1Content, formatString1Brace, formatString1End, formatString2Content, formatString2Brace, formatString2End, formatString1lContent, formatString1lBrace, formatString1lEnd, formatString2lContent, formatString2lBrace, formatString2lEnd, ParenL, ParenthesizedExpression, TupleExpression, ComprehensionExpression, BracketL, ArrayExpression, ArrayComprehensionExpression, BraceL, DictionaryExpression, DictionaryComprehensionExpression, SetExpression, SetComprehensionExpression, ArgList, subscript, FormatString, importList, ParamList, SequencePattern, MappingPattern, PatternArgList, newline, carriageReturn, space, tab, hash, parenOpen, dot, braceOpen, singleQuote, doubleQuote, backslash, bracketed, newlines, indentation, topIndent, trackIndent, legacyPrint, formatString1, formatString2, formatString1l, formatString2l, pythonHighlighting, spec_identifier, parser;
var init_dist6 = __esm({
  "../../node_modules/@lezer/python/dist/index.js"() {
    ...
    formatString1 = formatString(singleQuote, 1, formatString1Content, formatString1Brace, formatString1End);
    formatString2 = formatString(doubleQuote, 1, formatString2Content, formatString2Brace, formatString2End);
    formatString1l = formatString(singleQuote, 3, formatString1lContent, formatString1lBrace, formatString1lEnd);
    formatString2l = formatString(doubleQuote, 3, formatString2lContent, formatString2lBrace, formatString2lEnd);
...
//# sourceMappingURL=/build/_shared/dist-3FTRBHDT.js.map
