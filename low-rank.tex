\title{Sparse and Low-Rank \acrlong*{pfm}}
\label{cha:low-rank}
...
This chapter proposes a new \acrlong*{pfm} algorithm for spatio-temporal
...
The performance of the proposed \acrshort*{splorapfm} algorithm was asssesed on
